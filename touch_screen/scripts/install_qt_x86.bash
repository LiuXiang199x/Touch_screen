...
echo -e "\e[7m Step 2. Select ALL Qt5.4.0 components clicking on Select All button. Press Next >"
...
echo '#Qt5.4 configuration' >> ~/.bashrc
echo "QML_IMPORT_PATH=${INSTALLATION_PATH}/5.4/gcc/qml:$QML_IMPORT_PATH" >> ~/.bashrc
echo "PATH=${INSTALLATION_PATH}/5.4/gcc/bin:$PATH" >> ~/.bashrc

echo "export CMAKE_MODULE_PATH=${INSTALLATION_PATH}/5.4/gcc/lib/cmake" >> ~/.bashrc
